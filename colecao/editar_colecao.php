...
// Busca opções para os Selects (As flores do jardim)
...
<style>
    ...
    .btn-save-master { 
        ...
        font-weight: bold; width: 100%; margin: 40px 0; font-size: 1.2rem;
...
<script>
    $(document).ready(function() {
        // Inicializa o Select2 nos campos múltiplos
        if ($.fn.select2) {
            $('.select2').select2({
                theme: 'classic',
                width: '100%'
