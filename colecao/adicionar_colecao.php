...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // CORREÇÃO: Usar FILTER_DEFAULT e decodificar para garantir o apóstrofo puro.
        ...
        $stmt_colecao->execute([
            ':titulo' => $titulo, // Usa o valor PURIFICADO
            ...
            ':preco' => $preco,
            ':condicao' => $condicao,
            ':observacoes' => $observacoes, // Usa o valor PURIFICADO
                ...
                <form method="POST" action="adicionar_colecao.php" class="edit-form">
                    ...
                    <div class="colecao-grid">
                        ...
                        <fieldset>
                            ...
                            <input type="text" id="preco" name="preco" placeholder="99.99">
                            
                            <label for="condicao">Condição:</label>
                            <input type="text" id="condicao" name="condicao" placeholder="Ex: Near Mint">
                            
                            <label for="observacoes">Observações:</label>
                            <textarea id="observacoes" name="observacoes" rows="5" style="min-height: 100px; width: 100%;"><?php
                                $tipo_descricao = null;
